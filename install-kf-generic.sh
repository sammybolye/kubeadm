...
kubectl get pods -A -o=custom-columns='DATA:spec.containers[*].image'| sort |uniq > before-$1.list
...
kubectl get pods -A -o=custom-columns='DATA:spec.containers[*].image' |sort |uniq > after-$1.list
